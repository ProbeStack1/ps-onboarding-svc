...
public class AuditService {
    ...
    public void record(String organizationId, ResourceType resourceType, String resourceId, AuditAction action,
        ...
        auditLogRepository.save(AuditLog.builder()
                ...
                .actorPrincipalType(actor == null ? null : actor.principalType())
                .actorClientId(actor == null ? null : actor.clientId())
                .actorTokenType(actor == null ? null : actor.tokenType())
    ...
    private AuditLogResponse toResponse(AuditLog log) {
        return AuditLogResponse.builder()
                ...
                .actorPrincipalType(log.getActorPrincipalType())
                .actorClientId(log.getActorClientId())
                .actorTokenType(log.getActorTokenType())
